...
public class DetectSwipeGestureListenerR2 extends GestureDetector.SimpleOnGestureListener{
    ...
    private R2 activity = null;

    public R2 getActivity() {return activity;}

    public void setActivity(R2 activity){

...
public class DetectSwipeGestureListenerR3 extends GestureDetector.SimpleOnGestureListener {
    ...
    private R3 activity = null;

    public R3 getActivity() { return activity;}

    public  void setActivity(R3 activity) {this.activity = activity;}
